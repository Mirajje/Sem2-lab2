...
void menu()
{
    ...
    printf("Enter 1 for append, 2 for prepend, 3 for insertAt, 4 for find, 5 for getLength, 6 for set, 7 for pop, 8 for print, 9 for exit program\n");
    while (true)
    {
        t = -1;
        int index;
        ...
        switch (t)
        {
            ...
            case 7:
                ...
                std::cout << "Popped item is: " << item << std::endl;
                break;
        }
    }
